...
1. **PLANNING (Phase 1 & 2):** Research and propose a plan. 
    - **Barrier:** Read-only for tracked files. 
    - **Integrity:** Strategy proposal turn must be **Application-Implementation-Free**.
2. **EXECUTION (Phase 3):** Transcription of the approved plan.
    - **Forensic Verification:** Re-read files and confirm `./build_app` success before completion.
    - **Exclusivity:** Implement ONLY the approved plan.
