...
object AppLanguage {
    ...
    val SUPPORTED: List<SupportedLocale> = listOf(
        ...
        // bcp47 "in" is the legacy ISO code Android resource matching still prefers for
        // Indonesian (values-id / values-in). Pref tag stays product "id".
        SupportedLocale("id", "in", "id", R.string.lang_name_id),
