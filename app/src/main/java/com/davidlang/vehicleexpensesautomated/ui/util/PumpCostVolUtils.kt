...
/**
 * Mixed-fail / readable pump photos: trusted GT and **not** all-19 official exact
 * on both phone `01-03-33` and tablet `01-04-14` (start-172). Filter-out is only
 * no-GT or untrusted `?` (14 photos). The 50 all-both-OK are skipped. Historical
 * 15 “unreadables” are not a filter (13 stay here). 104 names, phone `file` order.
 * Source: `dev-ai-interaction/research/pump-red-runlength/mixed_fail_readable_0103.json`
 * key `mixed_fail_readable`. Pump grid “Mixed fail (104)”; `auto=mixedfail`.
 */
