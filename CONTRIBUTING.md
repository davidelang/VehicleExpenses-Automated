...
- **App overview and permissions:** [docs/OVERVIEW.md](docs/OVERVIEW.md), [docs/specs/PERMISSIONS_MODEL.md](docs/specs/PERMISSIONS_MODEL.md)
- **Illustrated user manual:** [docs/reference/USER_MANUAL_BUILD.md](docs/reference/USER_MANUAL_BUILD.md) — after editing `docs/user-manual/manual.md`, run `./scripts/render-user-manual.sh` and commit HTML + assets

## Agent Collaboration (Grok, Antigravity, and other engines)
...
- Agent-specific overlay: `GROK.md` (Grok) or `ANTIGRAVITY.md` (Antigravity). Shared rules are `AGENT_MANDATES.md`.

**Key modern rules (replacing all prior web-UI / cut-paste / sidebar instructions):**
- Use the CLI launchers from the worktree root: `../run-grok*` or `../run-antigravity*`. Shared rules do not assume one engine.
