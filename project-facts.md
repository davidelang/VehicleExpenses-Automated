...
- Manage vehicles + crop editor: `ui/vehicle/ManageVehiclesScreen.kt` — `EditCropsView` (ICRS crop rects, pinch/pan zoom 1–10×, +/- FABs)
- Landmarks dialog: `ui/components/LandmarkDebugDialog.kt` — launched via Show Landmarks from manage vehicles; image area uses same zoom pattern as EditCropsView
