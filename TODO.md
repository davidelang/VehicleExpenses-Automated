...
- [x] **DONE:** Remove Dynamic Detect Test (linked to `dev-ai-interaction/plans/remove-dynamic-detect-test.md`)
- [x] Delete `ExperimentPaddleDynamicScreen.kt`.
- [x] Remove navigation and menu entries from `MainActivity.kt`.
