...
- [ ] **ACTIVE: Revert srcH Geometry for Deskew Parity.** Revert `deskewMlKit` to use buffer-relative height for candidate filtering to match working version (24ab86a).
