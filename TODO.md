...
- [x] Streaming JSON with per-photo fragment staging to disk — plan: dev-ai-interaction/plans/streaming-json-with-per-photo-fragment-staging-to-disk-20260621-223000-plan.md
