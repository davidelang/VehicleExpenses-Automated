...
- [x] Phase 5: Wire capture for Set B
- [x] Phase 6: Wire capture for Set C
...
- [x] complete-real-4box-per-column-wiring-20260619-plan.md (15 phases)
- [x] finish-4box-per-column-cost-volume-wiring-20260619-plan.md (15 phases)
- [x] recovery-4box-cost-volume-classifier-wiring-20260619-plan.md (15 phases)

## Infrastructure & Protocol
- [x] **INTEGRATION:** Propose and approve Antigravity CLI integration plan.
- [x] **INTEGRATION:** Apply Antigravity overrides to GEMINI.md and configure setup_agent.sh runner logic.
- [x] **INTEGRATION:** Synchronize rule changes across master, agent-1, and agent-2 worktrees.
- [x] **INTEGRATION:** Apply startup fixes to new_agent_prompt, GEMINI.md, and run-antigravity.
- [x] **EXECUTE:** Clarify workspace roles at startup in runner scripts (linked to confine-workspace-roots.md).
...
- [x] **EXECUTE:** Implement branch-specific versioning with lightweight start-tags (linked to versioning-start-tag.md).
...
- [x] **TFLite Diagnostic:** Identified root cause of "garbage" output and proposed binarization/PSM fixes.
