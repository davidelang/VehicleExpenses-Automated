...
- [ ] dead-code-expandByUniformity-for-BCF-comment-P4-snapshots-20260621-plan.md — make expand dead for BCF + comment P4 snapshots + add debug (ExperimentPumpScreen.kt only)
  - [ ] Phase 1: Baseline forensic (no edit)
  - [ ] Phase 2: Add targeted debug logs
  - [ ] Phase 3: Comment out P4 image snapshot stores
  - [ ] Phase 4: Bypass doBOrDRetractedBlueAndPD in B/C/F
  - [ ] Phase 5: Final cross-check + build
