...
| `Set ink-gray-tight` | product **224+608** | Greyscale Otsu 7seg; inset **16px**; pad k; jump once | `finalKind=ink` k=1 |
...
| `Set rot-gray-tight` | product **224+608** | Oriented Y 7seg; inset **16px**; k-pad ±v; jump ±u | `finalKind=ink` k=1 |
