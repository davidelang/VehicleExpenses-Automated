...
**7seg Y Otsu fill (red/seed only, not energy):** `(look-bin + 8-connected recovered poison ink) / seed area`; band **0.05–0.45**; at most **3** extra valley splits on the frozen poison==0 keep-set.
