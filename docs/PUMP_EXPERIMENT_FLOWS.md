...
| `Set ink-energy-base` | product **224+608** | AABB INTERIOR_ENERGY; baseline seed; L/R jump | `final` = energy |
| `Set ink-energy-tight` | product **224+608** | Same; seed inset **16px** | tight |
| `Set ink-energy-retract` | product **224+608** | Same; T/B 1px expand-or-retract | edge-retract |
| `Set ink-gray-base` | product **224+608** | Greyscale Otsu 7seg; baseline; pad k; jump once | `finalKind=ink` k=1 |
| `Set ink-gray-tight` | product **224+608** | Same; inset **16px** | tight |
| `Set ink-gray-retract` | product **224+608** | Same; T/B 1px expand-or-retract | edge-retract |
| `Set ink-color-base` | product **224+608** | `color_adaptive` 7seg (`chromaMode=4`); baseline | metadata `color_adaptive` |
| `Set ink-color-tight` | product **224+608** | Same; inset **16px** | tight |
| `Set ink-color-retract` | product **224+608** | Same; T/B 1px expand-or-retract | edge-retract |
| `Set rot-energy-base` | product **224+608** | Oriented INTERIOR_ENERGY; baseline; jump ±u | no deskew |
| `Set rot-energy-tight` | product **224+608** | Same; u/v inset **16px** | tight |
| `Set rot-energy-retract` | product **224+608** | Same; ±v 1px expand-or-retract | edge-retract |
| `Set rot-gray-base` | product **224+608** | Oriented Y 7seg; baseline; k-pad ±v; jump ±u | `finalKind=ink` k=1 |
| `Set rot-gray-tight` | product **224+608** | Same; inset **16px** | tight |
| `Set rot-gray-retract` | product **224+608** | Same; ±v 1px expand-or-retract | edge-retract |
| `Set rot-color-base` | product **224+608** | Oriented `color_adaptive` 7seg; baseline | metadata `color_adaptive` |
| `Set rot-color-tight` | product **224+608** | Same; inset **16px** | tight |
