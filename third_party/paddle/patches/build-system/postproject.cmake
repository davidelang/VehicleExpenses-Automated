        ...
        if ((ARM_TARGET_ARCH_ABI STREQUAL "armv8"))
          if (${ANDROID_NDK_MAJOR})
            if(${ANDROID_NDK_MAJOR} GREATER_EQUAL "23")
                # LITE_WITH_ARM8_SVE2 is ifdefs only. Do not rewrite CMAKE_C/CXX_FLAGS
                # with +sve2 — that emits SVE in NEON TUs (SIGILL on Pixel 6).
                # Per-TU -march=+sve2 lives on math_arm_sve / sve/*.cc.
                message(STATUS "LITE_WITH_ARM8_SVE2: ifdefs on; +sve2 is per-TU not global")
            else()
