...
- Before each `./build_app`: `git add` the changed tracked source file(s) + `TODO.md`. (Stable facts updates to project-facts.md are tracked and may be included when relevant.)
