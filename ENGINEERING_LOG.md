...
## 2026-08-02 - i18n residual English + Indonesian screenshots

- Track A: residual chrome strings (Fuel Edit, Reports Lab, Settings volume/convert, sync form labels) + 11 locale packs
- Indonesian fix: values-in alias + AppLanguage bcp47 `in` for resource match
- Capture script `--strict`; id recapture on emulator-5556 (identical_to_en=0, unique=23)
- Rendered id user-manual.html; docs/i18n/README note


## 2026-08-02 - Local PR prepared: i18n_lang_packs

- Soft-reset history to 3 logical commits; backup-i18n_lang_packs @ pre-clean tip
- Restored master third_party .gitignore block (dropped accidental deletion)
...
## 2026-08-02 - Local PR updated after residual nits

- Folded nits into clean 3-commit history; regenerated PR-i18n_lang_packs.md
- Plan historical: i18n-residual-english-nits-cleanup-20260802-1856-plan.md
